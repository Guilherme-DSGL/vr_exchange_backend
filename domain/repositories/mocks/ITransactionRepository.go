...
func (_m *ITransactionRepository) Delete(ctx context.Context, id string) error {
...
func (_m *ITransactionRepository) GetById(ctx context.Context, id string) (entities.Transaction, error) {
	ret := _m.Called(ctx, id)
